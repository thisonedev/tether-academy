    ...
    lessons: [
      {
        ...
        shortTitle: 'Capture thinking content',
      ...
      },
      {
        ...
        shortTitle: 'Run concurrent calls',
        slug: 'concurrent',
    ...
    lessons: [
      {
        ...
        shortTitle: 'Build the voice loop',
    ...
    lessons: [
      {
        ...
        shortTitle: 'Batch decode a file',
        slug: 'bci-filesystem',
    ...
    lessons: [
      {
        ...
        shortTitle: 'Run SmolVLA inference',
        slug: 'vla-smolvla',
