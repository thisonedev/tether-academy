...
The data files at `./examples/qvac/fine-tuning/run-finetune/small_train_HF.jsonl` live next to this lesson's code. The output adapters go to `./tether-academy-app-desktop/output/finetune/` (the desktop app is the runtime, generated files live there).
