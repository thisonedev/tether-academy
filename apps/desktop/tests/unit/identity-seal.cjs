...
// Secret storage: the AES-256-GCM fallback used when no OS keychain is available.
...
// The key must move, not regenerate: every record sealed with it becomes unreadable otherwise.
